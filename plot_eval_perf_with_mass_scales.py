...
'''
This script plots the reward over training or evlauation runs. Input the directory or directories(relative path) containing the run(s) 
in the command line when running the script using the "--logdirs" argument. Add "--legend" argument to the command line to display the legend for different mass scales 
if applicable. Plot title and legend entries are currently hard coded. Output figure name can be set by adding 
"--outfig" argument and the desired name in the command line.   
'''
